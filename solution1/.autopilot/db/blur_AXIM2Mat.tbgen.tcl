...
set isOneStateSeq 0
set C_modelName {blur_AXIM2Mat}
set C_modelType { void 0 }
set C_modelArgList { 
	{ fb int 8 regular {axi_master 0}  }
	{ image_in int 32 regular {fifo 0}  }
...
set C_modelArgMapList {[ 
	{ "Name" : "fb", "interface" : "axi_master", "bitwidth" : 8, "direction" : "READONLY"} , 
 	{ "Name" : "image_in", "interface" : "fifo", "bitwidth" : 32, "direction" : "READONLY"} , 
...
set portList { 
	...
	{ image_in_dout sc_in sc_lv 32 signal 1 } 
	{ image_in_empty_n sc_in sc_logic 1 signal 1 } 
	{ image_in_read sc_out sc_logic 1 signal 1 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "image_in_dout", "direction": "in", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "image_in", "role": "dout" }} , 
 	{ "name": "image_in_empty_n", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "image_in", "role": "empty_n" }} , 
 	{ "name": "image_in_read", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "image_in", "role": "read" }} , 
...
set Spec2ImplPortList { 
	...
	image_in { ap_fifo {  { image_in_dout fifo_data 0 32 }  { image_in_empty_n fifo_status 0 1 }  { image_in_read fifo_update 1 1 } } }
