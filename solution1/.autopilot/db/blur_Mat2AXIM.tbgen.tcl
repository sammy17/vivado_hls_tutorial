...
set C_modelArgMapList {[ 
	{ "Name" : "img_data_stream_V", "interface" : "fifo", "bitwidth" : 8, "direction" : "READONLY"} , 
 	...
 	{ "Name" : "image_out", "interface" : "fifo", "bitwidth" : 32, "direction" : "READONLY"} ]}
...
set portList { 
	...
	{ image_out_dout sc_in sc_lv 32 signal 2 } 
	{ image_out_empty_n sc_in sc_logic 1 signal 2 } 
	{ image_out_read sc_out sc_logic 1 signal 2 } 
}
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "image_out_dout", "direction": "in", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "image_out", "role": "dout" }} , 
 	{ "name": "image_out_empty_n", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "image_out", "role": "empty_n" }} , 
 	{ "name": "image_out_read", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "image_out", "role": "read" }}  ]}
set Spec2ImplPortList { 
	...
	image_out { ap_fifo {  { image_out_dout fifo_data 0 32 }  { image_out_empty_n fifo_status 0 1 }  { image_out_read fifo_update 1 1 } } }
}
