...
#ifndef _blur_Array2Mat_HH_
#define _blur_Array2Mat_HH_
...
struct blur_Array2Mat : public sc_module {
    ...
    // Module declarations
    blur_Array2Mat(sc_module_name name);
    SC_HAS_PROCESS(blur_Array2Mat);
    ...
    sc_signal< sc_lv<11> > p_2_reg_121;
    sc_signal< sc_lv<46> > sext_cast_fu_132_p1;
    sc_signal< sc_lv<46> > sext_cast_reg_234;
    sc_signal< sc_lv<11> > row_V_fu_145_p2;
    sc_signal< sc_lv<11> > row_V_reg_242;
    sc_signal< sc_logic > ap_sig_cseq_ST_st2_fsm_1;
    sc_signal< bool > ap_sig_bdd_115;
    sc_signal< sc_lv<32> > fb_addr_reg_247;
    sc_signal< sc_lv<1> > exitcond2_fu_140_p2;
    ...
    sc_signal< sc_lv<1> > exitcond_reg_258;
    ...
    sc_signal< sc_lv<1> > ap_reg_ppstg_exitcond_reg_258_pp0_it1;
    sc_signal< bool > ap_sig_bdd_157;
    sc_signal< sc_logic > ap_reg_ppiten_pp0_it2;
    sc_signal< sc_lv<11> > col_V_fu_217_p2;
    sc_signal< sc_lv<8> > fb_pix_reg_267;
    sc_signal< sc_logic > ap_sig_cseq_ST_st9_fsm_8;
    sc_signal< bool > ap_sig_bdd_177;
    sc_signal< sc_lv<11> > p_s_reg_110;
    ...
    sc_signal< sc_lv<12> > p_cast_fu_136_p1;
    sc_signal< sc_lv<22> > p_shl_fu_151_p3;
    sc_signal< sc_lv<18> > p_shl2_fu_163_p3;
    sc_signal< sc_lv<23> > p_shl_cast_fu_159_p1;
    sc_signal< sc_lv<23> > p_shl2_cast_fu_171_p1;
    sc_signal< sc_lv<23> > r_V_fu_175_p2;
    sc_signal< sc_lv<44> > r_V_cast_fu_181_p1;
    sc_signal< sc_lv<46> > tmp_55_fu_185_p1;
    sc_signal< sc_lv<46> > tmp_56_fu_189_p2;
    sc_signal< sc_lv<12> > p_2_cast_fu_208_p1;
    ...
    static const sc_lv<11> ap_ST_st13_fsm_10;
    ...
    void thread_col_V_fu_217_p2();
    void thread_exitcond2_fu_140_p2();
    ...
    void thread_p_2_cast_fu_208_p1();
    void thread_p_cast_fu_136_p1();
    void thread_p_shl2_cast_fu_171_p1();
    void thread_p_shl2_fu_163_p3();
    void thread_p_shl_cast_fu_159_p1();
    void thread_p_shl_fu_151_p3();
    void thread_r_V_cast_fu_181_p1();
    void thread_r_V_fu_175_p2();
    void thread_row_V_fu_145_p2();
    void thread_sext_cast_fu_132_p1();
    void thread_tmp_55_fu_185_p1();
    void thread_tmp_56_fu_189_p2();
